...
type Attribute struct {
	...
	// 1=>Product Attribute, 2=>Product Confirm Attribute, 3=>Channel Exclusion Attribute
...
func (*Attribute) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case attribute.FieldID, attribute.FieldType, attribute.FieldStatus:
			values[i] = new(sql.NullInt64)
		case attribute.FieldValue, attribute.FieldDescription:
...
func (a *Attribute) Unwrap() *Attribute {
	...
	if !ok {
		panic("gen: Attribute is not a transactional entity")
	}
